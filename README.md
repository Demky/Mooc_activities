...
--- |--- |--- |--- |--- |
Tic-Tac-Toe Checker | ticTactoeChecker.js | JavaScript | :star: | _In progress_ check if a Tic Tac Toe board's is solved
Decode the Morse code | morseDecoder.js | JavaScript | 0 | write a Morse decoder script
Two fighters, one winner | twoFighters.js | JavaScript | 0 | two _objects_ fight with their _properties_; write a function to tell who win
...
Sum of Digits / Digital Root | digitalRoot.js | JavaScript | :star: | Recursive sum of all the digits in a number till there is only 1 digit left
Duplicate Encoder | duplicateEncoder.js | JavaScript | :star:+ |  Convert a string with "(" if a character appears only once or ")" if that character is duplicated
